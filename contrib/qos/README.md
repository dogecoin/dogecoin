...
This means one can have an always-on coingreend instance running, and another local coingreend/coingreen-qt instance which connects to this node and receives blocks from it.
