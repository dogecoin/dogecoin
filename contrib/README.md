...
Files used during the gitian build process. For more information about gitian, see the [the Dogecoin Core documentation repository](https://github.com/dogecoin/dogecoin/tree/master/doc).
