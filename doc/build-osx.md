...
To build Dogecoin Core without wallet, see [*Disable-wallet mode*](#disable-wallet-mode).
...
1. Clone the Dogecoin Core source code:
    ```shell
...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, Dogecoin Core may be
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Dogecoin"

touch "/Users/${USER}/Library/Application Support/Dogecoin/dogecoin.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Dogecoin/dogecoin.conf"
```

The first time you run dogecoind, it will start downloading the blockchain. This process could
