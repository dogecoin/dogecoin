Pepecoin Core version 1.14.6 is now available from:

  <https://github.com/pepecoinppc/pepecoin/releases/tag/v1.14.6/>

This is a new minor version release, including important security updates and
changes to network efficiency. All Pepecoin Core users - miners, services,
...
To receive notifications about updates, subscribe to the release mailing list:
  ...
  <https://sourceforge.net/projects/pepecoin/lists/pepecoin-releases>
...
Pepecoin network from 1 PEPE to 0.01 PEPE. The full recommendation can be found
...
```
pepecoin-cli addnode <address> remove
```
...
```
pepecoin-cli liststucktransactions
```
...
```
pepecoin-cli setmaxconnections <desired_amount>
```
...
```
pepecoin-cli rescan <start_block>
```
...
efforts to make Pepecoin more accessible to people that do not speak English.
...
* Improved and updated the [bip list](bips.md) documentation that explains the
  protocol features implemented by Pepecoin Core.
