...
Dogecoin Core version 0.14.0 is now available from:

  <https://dogecoin.com/bin/dogecoin-core-0.14.0/>
...
The Alert System has been removed in 1.14.0 due to it's
[removal upstream in Bitcoin Core](https://bitcoin.org/en/alert/2016-11-01-alert-retirement).
