...
Setup
---------------------
Dogecoin Core is the original Dogecoin client and it builds the backbone of the network. It downloads and, by default, stores the entire history of Dogecoin transactions (which is currently more than 20 GBs); depending on the speed of your computer and network connection, the synchronization process can take anywhere from a few hours to a day or more.

To download Dogecoin Core, visit [dogecoin.com](https://dogecoin.com/).
