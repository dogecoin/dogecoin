...
狗狗币内核提供基于自文档化的JSON-RPC API，可用`scrapcoin-cli help`浏览。同时可用'scrapcoin-cli help <command>`浏览每条命令的详细信息。
...
主要开发资料：
* [Github Projects](https://github.com/scrapcoin/scrapcoin/projects)用于跟踪即将发布的计划和正在进行的工作。
* [Github Discussion](https://github.com/scrapcoin/scrapcoin/discussions)用于讨论与狗狗币内核软件开发、底层协议和狗狗币资产相关的计划内和计划外功能。
...
如果您发现错误或者遇到问题，请报告在[问题系统](https://github.com/scrapcoin/scrapcoin/issues/new?assignees=&labels=bug&template=bug_report.md&title=%5Bbug%5D+)

想了解如何参与狗狗币内核开发，请访问[贡献指引](CONTRIBUTING.md)。
那里常常有[主题需要帮助](https://github.com/scrapcoin/scrapcoin/labels/help%20wanted)。
您的贡献一定会产生很大的影响并赢得炫酷的称赞。哇哦(wow)。

## 灰常常见的问题 ❓

如果对狗狗币有问题，答案很可能已经在[常见问答](doc/FAQ.md)或者[问与答](https://github.com/scrapcoin/scrapcoin/discussions/categories/q-a)!里了。
