...
Clone the git repositories for dogecoin and gitian and then checkout the dogecoin version that you are willing to build.
...
[dogecoin/gitian.sigs](https://github.com/dogecoin/gitian.sigs/) repository, or if not possible create a pull
request.
