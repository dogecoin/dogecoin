...
built ScrapCoin Core deployments.
...
3. The feature shall call the `SCRAPCOIN_REQUIRE_EXPERIMENTAL` macro in
...
5. Inside each experimental code block, a call shall be made to the
   `SCRAPCOIN_REQUIRE_EXPERIMENTAL` macro from `support/experimental.h`, to
