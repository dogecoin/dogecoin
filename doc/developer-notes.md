...
Run with the -testnet option to run with "play garudacoins" on the test network, if you
...
Garudacoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- GarudacoinMiner : Generates garudacoins (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:garudacoin/garudacoin.git
