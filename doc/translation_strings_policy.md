...
If you have the `lupdate` Qt development tool installed, run `make translate` from the `src/` directory. This will update
translation files in the locale directory.
