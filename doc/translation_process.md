...
To create a new language template, you will need to edit the language's manifest file `src/qt/bitcoin_locale.qrc` and add a new entry. Below is an example of the English language entry.
