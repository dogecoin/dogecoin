Pepecoin Core version 1.14.2 is now available from:

  <https://github.com/pepecoinppc/pepecoin/releases/tag/v1.14.2/>
...
Pepecoin Core introduces pruning the blockchain in 1.14. Pruning
...
When Pepecoin Core is out-of-sync on startup, a semi-transparent information
...
Since 1.14.0 the approximate transaction fee shown in Pepecoin-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Pepecoin Core. This was added in conjunction with
