# Dingocoin Core 1.8.1

Dingocoin Core 1.8.1 is primarily a bugfix release, bringing Dingocoin Core in
line with Bitcoin 0.9.3. Dingocoin Core 1.8.1 also adds in support for printing
...
* Disable Transifex based translation process (not used by Dingocoin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 Dingocoin Core clients
* Use HTTPS with dingochain.info
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/dingocoin/dingocoin/issues/134).
