# ScrapCoin Core 1.8.1

ScrapCoin Core 1.8.1 is primarily a bugfix release, bringing ScrapCoin Core in
line with Bitcoin 0.9.3. ScrapCoin Core 1.8.1 also adds in support for printing
...
## ScrapCoin Core Release Notes

* Translation improvements and corrections
* Disable Transifex based translation process (not used by ScrapCoin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 ScrapCoin Core clients
* Use HTTPS with scrapchain.info
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/scrapcoin/scrapcoin/issues/134).
