# Contributing to ScrapCoin Core

ScrapCoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/scrapcoin/scrapcoin/labels/help%20wanted)
* [Projects](https://github.com/scrapcoin/scrapcoin/projects)
* [ScrapCoindev on reddit](https://www.reddit.com/r/scrapcoindev/)

## Branch Strategy

ScrapCoin Core's default branch is intentionally a stable release, so that anyone
...
ScrapCoin Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future ScrapCoin Core
releases will automatically benefit from these.

When refactoring ScrapCoin-specific code, please keep refactoring requests short,
...
The following applies to code changes to ScrapCoin Core, and is not to be
confused with overall ScrapCoin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into ScrapCoin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of ScrapCoin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards ScrapCoin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the ScrapCoin consensus, it must have been
