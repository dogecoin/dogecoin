...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        test_pepecoin_wallet_minchange(rbf_node, dest_address)
...
def test_settxfee(rbf_node, dest_address):
    # Pepecoin: Increment is fixed, so this test tests for settxfee not making a difference
...
def test_pepecoin_wallet_minchange(rbf_node, dest_address):
