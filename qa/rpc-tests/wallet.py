...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210.000 SCRAP from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1.000.000 scrap in block rewards plus fees, but
        ...
        # Send 100000 SCRAP with subtract fee from amount
