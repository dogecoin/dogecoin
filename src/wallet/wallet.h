...
//Dogecoin-TODO: Update this
//! -m_discard_rate default
static const CAmount DEFAULT_DISCARD_FEE = COIN / 2;
//! -mintxfee default
...
public:
     ...
     */
    static CAmount GetMinimumFee(const CMutableTransaction& tx, unsigned int nTxBytes, const CCoinControl& coin_control, const CTxMemPool& pool, const CBlockPolicyEstimator& estimator, FeeCalculation *feeCalc);
    /**
