...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in Garudacoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to Garudacoin values
        ...
        vSeeds.push_back(CDNSSeedData("multigaruda.org", "seed.multigaruda.org", true));
        vSeeds.push_back(CDNSSeedData("multigaruda.org", "seed2.multigaruda.org"));
        ...
        //TODO: fix this for garudacoin -- plddr
