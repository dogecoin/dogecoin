...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    genesis.vtx.emplace_back(MakeTransactionRef(std::move(txNew)));
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back(CDNSSeedData("multidoge.org", "seed.multidoge.org", true));
        vSeeds.emplace_back(CDNSSeedData("multidoge.org", "seed2.multidoge.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back(CDNSSeedData("jrn.me.uk", "testseed.jrn.me.uk"));
