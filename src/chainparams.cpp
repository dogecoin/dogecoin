...
public:
    CMainParams() {
        ...
        consensus.BIP65Height = 15000000; // Dogecoin: Use a stupidly high value as a placeholder until 1.14 locks this in
        ...
        chainTxData = ChainTxData{
            ...
            1514549787, // * UNIX timestamp of last known number of transactions
            32796624,   // * total number of transactions between genesis and that timestamp
