...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in ScrapCoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to ScrapCoin values
        ...
        // ScrapCoin genesis block - to be computed with proper nonce and merkle root
        // Timestamp: "ScrapCoin Genesis Block - Decentralized Recycling Economy"
        // Reward: 50 SCRAP
        genesis = CreateGenesisBlock(1773234766, 1526115, 0x1e0ffff0, 1, 50 * COIN);

        consensus.hashGenesisBlock = uint256S("0x0000083e11af168c492eb117c61c5403bdc12675cb86a3346923cc72b83c29ce");
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        assert(consensus.hashGenesisBlock == uint256S("0x0000083e11af168c492eb117c61c5403bdc12675cb86a3346923cc72b83c29ce"));
        assert(genesis.hashMerkleRoot == uint256S("0x450daa53b9394e5d1f790f7d8e29e663bbcb3ffd5024bc552a6d51ce6aa04f76"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("seed.scrapcoin.org", "seed.scrapcoin.org", true));
        vSeeds.push_back(CDNSSeedData("node.scrapcoin.org", "node.scrapcoin.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("testnet-seed.scrapcoin.org", "testnet-seed.scrapcoin.org", true));
        vSeeds.push_back(CDNSSeedData("testnet-node.scrapcoin.org", "testnet-node.scrapcoin.org"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,116); // Testnet addresses start with 'T' (0x74)
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,196); // 0xc4
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,244); // 0xf4
