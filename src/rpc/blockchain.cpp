...
UniValue blockheaderToJSON(const CBlockIndex* blockindex)
{
    ...
    result.push_back(Pair("chainwoof", blockindex->nChainWoof.GetHex()));
...
UniValue getdifficulty(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw runtime_error(
            "getdifficulty\n"
            "\nReturns the proof-of-woof difficulty as a multiple of the minimum difficulty.\n"
            "\nResult:\n"
            "n.nnn       (numeric) the proof-of-woof difficulty as a multiple of the minimum difficulty.\n"
            "\nExamples:\n"
...
UniValue getblockheader(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
            ...
            "  \"chainwoof\" : \"0000...1f3\"     (string) Expected number of hashes required to produce the current chain (in hex)\n"
...
UniValue getblock(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
            ...
            "  \"bits\" : \"1d00ffff\", (string) The bits\n"
            "  \"difficulty\" : x.xxx,  (numeric) The difficulty\n"
            "  \"chainwoof\" : \"xxxx\",  (string) Expected number of hashes required to produce the chain up to this block (in hex)\n"
            "  \"previousblockhash\" : \"hash\",  (string) The hash of the previous block\n"
            "  \"nextblockhash\" : \"hash\"       (string) The hash of the next block\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
UniValue getblockchaininfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw runtime_error(
            ...
            "  \"chainwoof\": \"xxxx\"     (string) total amount of woof in active chain, in hexadecimal\n"
    ...
    obj.push_back(Pair("chainwoof",             chainActive.Tip()->nChainWoof.GetHex()));
...
UniValue getchaintips(const JSONRPCRequest& request)
{
    ...
    BOOST_FOREACH(const CBlockIndex* block, setTips)
    {
        ...
        if (chainActive.Contains(block)) {
            ...
            // The headers for this block are valid, but it has not been validated. It was probably never part of the most-woof chain.
...
UniValue preciousblock(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "\nTreats a block as if it were received before others with the same woof.\n"
