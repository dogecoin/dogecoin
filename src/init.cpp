...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-dustlimit=<amt>", strprintf(_("Amount of DOGE under which a transaction output is considered dust, in Koinu (default: %u)"), DEFAULT_DUST_LIMIT));
