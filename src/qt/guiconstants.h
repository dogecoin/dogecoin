...
#define QAPP_ORG_NAME "ScrapCoin"
#define QAPP_ORG_DOMAIN "scrapcoin.org"
#define QAPP_APP_NAME_DEFAULT "ScrapCoin-Qt"
#define QAPP_APP_NAME_TESTNET "ScrapCoin-Qt-testnet"
