...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("dogecoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'dogecoin://' is not a valid URI. Use 'dogecoin:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // dogecoin: URI
    {
