...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Dingocoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Dingocoin (as there is no actual maximum coins)
