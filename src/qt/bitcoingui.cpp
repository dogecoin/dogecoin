    ...
    platformStyle(_platformStyle)
{
    ...
    // ScrapCoin: load fallback font in case Comic Sans is not available on the system
    ...
    // ScrapCoin: load this bundled font for Settings -> Options in case it's not available on the system
    ...
    // ScrapCoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // ScrapCoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ScrapCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and scrapcoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ScrapCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ScrapCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a scrapcoin: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a ScrapCoin private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible ScrapCoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to ScrapCoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("ScrapCoin"); // default title
