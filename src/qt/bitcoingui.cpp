    ...
    platformStyle(_platformStyle)
{
    ...
    // Garudacoin: load fallback font in case Comic Sans is not available on the system
    ...
    // Garudacoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Garudacoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Garudacoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and garudacoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Garudacoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Garudacoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a garudacoin: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Garudacoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Garudacoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Garudacoin"); // default title
