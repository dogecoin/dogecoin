...
{
    SetMockTime(11);
    auto mainParams = CreateChainParams(CBaseChainParams::MAIN);
    const std::vector<unsigned char>& alertKey = mainParams->AlertKey();
...
BOOST_AUTO_TEST_CASE(AlertNotify)
{
    ...
    fs::path temp = fs::temp_directory_path() / strprintf("alertnotify-%lu_%i.txt", (unsigned long)GetTime(), (int)(InsecureRandRange(100000)));
