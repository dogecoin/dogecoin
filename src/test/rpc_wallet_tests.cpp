...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
	...
	/* Illegal address */
	BOOST_CHECK_THROW(CallRPC("verifymessage DEaT9KZM6b6oDZMr8pj7pWTLZSdtYZFAx " + retValue.get_str() + " mymessage"), runtime_error);
	/* wrong address */
	BOOST_CHECK(CallRPC("verifymessage DEaT9KZM6b6oDZMr8pj7pWTLZSdtYZFAx8 " + retValue.get_str() + " mymessage").get_bool() == false);
