...
Changes must be tested by somebody other than the developer who wrote the
code. It is useful to add a test plan to the pull request description if
...
[subreddit](http://reddit.com/r/dogecoindev)

[Tags](https://github.com/dogecoin/dogecoin/tags) are created regularly to indicate new official, stable release versions of Dogecoin Core.
