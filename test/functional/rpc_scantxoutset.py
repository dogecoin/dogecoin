...
class ScantxoutsetTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress("nYxgyQgsm4a6SLiccPQkvHnrLuJqYgdk1n", 0.008) # (m/0'/0'/0')
        self.nodes[0].sendtoaddress("nXVgQeMsb5x5Vbj6vE5XkdgZ3VKfYgY9VA", 0.016) # (m/0'/0'/1')
        self.nodes[0].sendtoaddress("nqnq8VEfnBw2uDS47RmVDUnSUHLzfYMKkQ", 0.032) # (m/0'/0'/1500')
        self.nodes[0].sendtoaddress("ne7MQ3GiCjFvdpXR1iLtJTLZYCPgnCCGsN", 0.064) # (m/0'/0'/0)
        self.nodes[0].sendtoaddress("nb8t3u66GQnML9rVn9akCUnBN75icvtLYz", 0.128) # (m/0'/0'/1)
        self.nodes[0].sendtoaddress("nZL6AqgkZq5EHWHtFiVTBYqkYgSbZTABmM", 0.256) # (m/0'/0'/1500)
        self.nodes[0].sendtoaddress("nXpCEDTAbyZL9Q67FEgSMocQyohPUCi4Qk", 0.512) # (m/1/1/0')
        self.nodes[0].sendtoaddress("nUTXnXzp6FiUDfWBmNZzKtvyj3uNFSy3xu", 1.024) # (m/1/1/1')
        self.nodes[0].sendtoaddress("ncaJaPcKzjwY1AdBvhe94nyX3dam9zGNJU", 2.048) # (m/1/1/1500')
        self.nodes[0].sendtoaddress("nhLgmhBXZgzedPSbsmgSRXW6EpKaK3q74h", 4.096) # (m/1/1/0)
        self.nodes[0].sendtoaddress("nmVKuLKhrN6ajCQcwGh2okUU94oAQsLpTi", 8.192) # (m/1/1/1)
        self.nodes[0].sendtoaddress("nd5Lq2Lk8AwCokaaTvujRq2LzB2dd726Ud", 16.384) # (m/1/1/1500)
