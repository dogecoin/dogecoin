...
class DisableWalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        self.nodes[0].generatetoaddress(1, 'nbKkSz78JGfsPqitXGcqgHhrDrgizjB3bW')
        assert_raises_rpc_error(-5, "Invalid address", self.nodes[0].generatetoaddress, 1, 'A8tPcraiJcyw6k8tLrK36vc6DSAsXwu8f7')
