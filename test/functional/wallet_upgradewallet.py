...
class UpgradeWalletTest(BitcoinTestFramework):
    ...
    @staticmethod
    def test_upgradewallet(wallet, previous_version, requested_version=None, expected_version=None):
    ...
    @staticmethod
    def test_upgradewallet_error(wallet, previous_version, requested_version, msg):
        assert_equal(wallet.getwalletinfo()["walletversion"], previous_version)
        assert_equal(wallet.upgradewallet(requested_version),
            {
                "wallet_name": "",
