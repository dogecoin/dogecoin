...
class SegWitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        txid1 = send_to_witness(1, self.nodes[0], find_spendable_utxo(self.nodes[0], 500000), self.pubkey[0], False, Decimal("499999.996"))
        ...
        tx.vout.append(CTxOut(int(499999.99 * COIN), CScript([OP_TRUE, OP_DROP] * 15 + [OP_TRUE])))
        ...
        tx.vout.append(CTxOut(int(499999.95 * COIN), CScript([OP_TRUE, OP_DROP] * 15 + [OP_TRUE])))  # Huge fee
        tx.calc_sha256()
